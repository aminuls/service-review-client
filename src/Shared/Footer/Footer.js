         ...
         <div className="card w-100 border-0 rounded-0 bg-dark text-light px-2 py-4 py-lg-5">
            <div className="card-body border-0">
               <Link to="/" className="text-decoration-none text-white">
                  <img src="../../logo.png" alt="logo" className="logo mb-1" />
                  <div className="company fs-2">
                     <p className="m-0 lh-1">Wild</p>
                     <p className="m-0 lh-1">Photography</p>
                  </div>
               </Link>
               <p className="card-text fw-light fs-6 mt-2">Providing reliable photography since 1992</p>
               <div>
                  <ul className="navbar-nav fs-6 gap-lg-4 gap-md-4 flex-md-row justify-content-center">
               ...
               <div className="mt-3">
                  <p>Copyright © 2022 - All right reserved by Wild Photography</p>
               </div>
            </div>
         </div>
      </div>
